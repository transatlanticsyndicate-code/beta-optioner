...
const WHATS_NEW_ITEMS = [
  {
    ...
    description: 'Новая кнопка "Волшебный подбор" автоматически подбирает оптимальные опционы для защиты вашей позиции. Система анализирует все доступные опционы и предлагает лучший вариант по критериям покрытия убытка и ликвидности.',
    icon: '🪄'
  }
];
...
const WhatsNewModal = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Заголовок */}
        <div className="relative bg-gradient-to-r from-purple-500 to-violet-500 rounded-t-2xl p-6 text-white">
          <button
            onClick={handleClose}
