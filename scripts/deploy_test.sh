...
echo -e "${BLUE}🚀 Начинаем деплой на test.optioner.online...${NC}"
...
pm2 restart optioner-backend-test || pm2 start /var/www/test/ecosystem.test.config.js
...
echo -e "${GREEN}🌐 Проверь: https://test.optioner.online${NC}"
